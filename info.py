...
REQ_PICS = (environ.get('REQ_PICS', 'https://graph.org/file/c33108e606e418468d675.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/ce22c8888b55e4d11cdbc.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/c063e6a04206ba79d1eaa.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/ce22c8888b55e4d11cdbc.jpg")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <b>File Name</b>: <code>{file_name}</code> \n\n📌 <b>Send this file in this Bot</b> [𝗙𝗶𝗹𝗲 & 𝗩𝗶𝗱𝗲𝗼 𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗿 𝗕𝗼𝘁](https://t.me/FilmyFl2Bot)')
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", '')
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", '🏷 𝖳𝗂𝗍𝗅𝖾: <a href={url}>{title}</a> \n🐭 𝖸𝖾𝖺𝗋: {year} \n⭐️ 𝖱𝖺𝗍𝗂𝗇𝗀𝗌: {rating}/ 10  \n🎭 𝖦𝖾𝗇𝖾𝗋𝗌: {genres} \n\n🎊 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 [[ꜰɪʟᴍᴄʟᴀɴ]](t.me/FilmClan)')
